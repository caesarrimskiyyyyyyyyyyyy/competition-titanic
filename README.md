...
|---|---|---|---|---:|---:|---:|
| Baseline | Logistic Regression | Исходные признаки | `C=1.0` | 0.795 | 0.018 | — |
...
Положить `train.csv` и `test.csv` в `data/raw/`, затем выполнить:
...
Команда обучит финальную модель и создаст `submissions/random_forest_v1.csv`.
