...
| 1.1 | Logistic Regression | Feature engineering v1 | `C=1.0` | 0.832 | 0.015 | +0.037 |
| 1.2 | Logistic Regression | Feature engineering v1 | `C=0.1` | **0.832** | **0.008** | **+0.037** |
| 2.1 | SVC | Feature engineering v1 | RBF, базовые параметры | 0.829 | 0.017 | +0.034 |
| 3.1 | Decision Tree | Feature engineering v1 | Базовые параметры | 0.790 | 0.031 | -0.005 |
| 4.1 | Random Forest | Feature engineering v1 | `n_estimators=500` | 0.815 | 0.015 | +0.020 |
